...
const AddAdvanceSalaryModal = ({ isVisible, onClose, onSave }) => {
    ...
    const handleSave = () => {
        if (!employeeId.trim() || !employeeName.trim() || !amount.trim()) {
            showCustomAlert('Please fill all fields: Employee ID, Employee Name, and Amount.');
            return;
        }
        ...
        const newAdvanceSalary = {
            ...
            image: imageUri, // Pass the selected image URI (will be null if none chosen)
        };
    ...
    return (
        ...
        >
            ...
            {/* Custom Alert Modal (local to AddAdvanceSalaryModal) */}
            <Modal
                animationType="fade"
                transparent={true}
